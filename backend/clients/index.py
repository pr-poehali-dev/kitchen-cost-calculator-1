...
<p class="no-indent">ООО «Интерьерные решения», в лице менеджера <span class="ul">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>, <span class="ul" style="min-width:80px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>, действующего на основании доверенности № <span class="ul" style="min-width:40px">&nbsp;&nbsp;&nbsp;&nbsp;</span> от <span class="ul" style="min-width:80px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>, именуемый в дальнейшем «Исполнитель», и <strong>{fname}</strong>, именуемый (ая) в дальнейшем «Заказчик», действующий (ая) как физическое лицо, с одной стороны, отдельно именуемые – «Сторона», а совместно именуемые – «Стороны», заключили настоящий Договор о нижеследующем:</p>
<p class="sec">1. ПРЕДМЕТ ДОГОВОРА</p>
...
<p>2.2.7. Если в будущем сборка мебели будет осуществляться силами ООО «Интерьерные решения»: на основании отдельно заключенного договора об оказании услуг, Заказчик обязан вскрыть упаковку в присутствии уполномоченного лица ООО «Интерьерные решения», осуществляющего сборку мебели.<br>Если сборка мебели будет осуществляться Заказчиком самостоятельно, в том числе с привлечением третьих лиц, не имеющим отношения к ООО «Интерьерные решения», Заказчик осуществляет осмотр содержимого упаковки на предмет видимых дефектов мебели в присутствии представителя Исполнителя.<br>Если Заказчик пожелает не производить распаковку мебели до момента окончания оказания услуг по настоящему Договору, он лишается права ссылаться впоследствии на недостатки, обнаруженные им до вскрытия упаковки.</p>
...
<tr><td>ООО «ИНТЕРЬЕРНЫЕ РЕШЕНИЯ»<br>ИНН/КПП: 6450106826/645001001<br>ОГРН: 1196451012251<br>Юридический и фактический адрес: 410018, Российская Федерация, Саратовская область, Саратов г., Усть-Курдюмская, д.3, помещение 1<br>Банковские реквизиты:<br>АО «Банк «Агророс», г. Саратов<br>БИК: 046311772<br>Рас/с: 40702810100000011571<br>Кор/с: 30101810600000000772<br>Телефон: (8452) 599-700; +79085503883<br>E-mail: kuhmagia@yandex.ru</td>
...
<p>3.3. В случае, если в период выполнения Работ будут выявлены недостатки элементов мебели и иных изделий, которые необходимо устранять, то срок выполнения Работ будет увеличен на срок устранения недостатков. Заказчик и Подрядчик пришли к соглашению, что если выявленные недостатки возникли в результате действий Заказчика и/или третьих лиц, не имеющим отношения к ООО «Интерьерные решения», то устранение недостатков осуществляется за счет Заказчика.</p>
...
<div class="city-date"><span>г. Саратов</span><span>«____» ______________ 20____ г.</span></div>
...
def _build_docx(c: dict, doc_type: str) -> bytes:
    ...
    if doc_type == 'contract':
        ...
        run_city = p.add_run('г. Саратов'); _set_font(run_city, 11)
        p.add_run('\t\t\t\t')
        run_date = p.add_run(f'№ {contract_num} от {contract_date_full}'); _set_font(run_date, 11)

        para(f'ООО «Интерьерные решения», в лице менеджера {manager_line}, действующего на основании доверенности № ____ от ____________, именуемый в дальнейшем «Подрядчик», и гр. {fname}, именуемый (ая) в дальнейшем «Заказчик», действующий (ая) как физическое лицо, с одной стороны, отдельно именуемые – «Сторона», а совместно именуемые – «Стороны», заключили настоящий Договор о нижеследующем:', indent=False)
        ...
        sig_table(
            ['Подрядчик', f'ООО «Интерьерные решения»\nОГРН: 1196451012251, ИНН: 6450106826\n410018, Саратовская обл., г. Саратов,\nул. Усть-Курдюмская, д. 3, пом. 1\n\nМенеджер: {manager_line}\n\nПодпись: ______________________________\nМ.П.'],
