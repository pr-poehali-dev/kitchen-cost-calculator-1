...
def build_docx(c: dict, doc_type: str, company: dict) -> bytes:
    ...
    if doc_type == 'contract':
        ...
        para('6.3. Приемка изготовленной мебели производится:\n- в случае самовывоза Заказчиком по адресу склада Подрядчика;\n- в случае доставки мебели Подрядчиком в рамках заключенного между Заказчиком и Подрядчиком дополнительного договора доставки мебели по адресу Заказчика.')
