...
export function buildPreviewHtml(template: Template): string {
  ...
  *{box-sizing:border-box}
  ...
  .page{width:${pageW};background:#fff;box-shadow:0 2px 8px rgba(0,0,0,0.25);padding:${contentPaddingTop}mm ${mRight}mm ${contentPaddingBottom}mm ${mLeft}mm;margin:12px auto;position:relative}
  ${lh.css}
