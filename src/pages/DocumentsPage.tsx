  ...
  return (
    <div className="flex flex-col h-full animate-fade-in">
      <div className="border-b border-border bg-[hsl(220,14%,11%)] px-4 md:px-6 py-3 md:py-4 shrink-0">
        <h1 className="text-base font-semibold text-foreground">Конструктор документов</h1>
        <p className="text-[hsl(var(--text-muted))] text-xs mt-0.5">Шаблоны договоров, актов, технических проектов и других документов</p>
      </div>
